...
function Update() {
  ...
  useEffect(()=>{
    axios.get(`https://port-0-backend-mbeeoks1e1ce5c07.sel4.cloudtype.app/goods/${g_code}`)
    //성공이면 출력
    .then(res=>{
  ...
  const handleSubmit=(e)=>{  
    ...
    axios.put(`https://port-0-backend-mbeeoks1e1ce5c07.sel4.cloudtype.app/goods/update/${g_code}`,{
